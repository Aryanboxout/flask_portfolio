...
| Week Tasks | Tangibles (Links to RGB)| Assigned to: | Individual Grades
|:-----|:--------------------| :--------------------|:--------------------|
| Multiply and Divide by 2 (Shift).  In this example, make the Bits change positions.  Start 2^0 to 2^15.  If you multiply by 2 then 2^0 bit becomes 2^1, 2^1 to 2^2.  If you divide 2^15 becomes 2^14. | [Gray Scale](https://github.com/Aryanboxout/flask_portfolio/commit/1dd6b03dbf35318b8a91aa96d0dff87477d7ed13) | Tanay Rayavarapu | 1/1| 
